resolve_experiment() {
  ...
  case "$1" in
    ...
    babi)
		...
		ARGS=(--data-dir "${BABI_DIR:?set BABI_DIR to the bAbI en-10k dir}" --tasks 1 2 3 --epochs 30 --batch-size 128 --t-max 2.0 --d-model 128 --n-heads 8 --d-ff 512 --seed 42 --runs 3 --log-every 1)
